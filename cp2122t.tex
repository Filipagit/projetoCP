...
em anexo) e a uma função auxiliar com o tipo \ensuremath{[\mskip1.5mu (\Conid{Pos},\Conid{Pos})\mskip1.5mu]\to \Conid{Map}\to \Conid{Map}} definida como
um \emph{catamorfismo de listas}. Tal como anteriormente, anote as propriedades seguintes sobre
\ensuremath{\Varid{markMap}}:
\begin{itemize}\em
...
\end{itemize}
\textbf{Nota:} Caso esteja a ter dificuldades a implementar a função \ensuremath{\Varid{markMap}}, estude
a função \ensuremath{\Varid{subst}} (disponibilizada em anexo) pois as duas funções tem
algumas semelhanças.
\end{enumerate}
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{putStr}\;\text{\ttfamily \char34 Please~provide~the~target~position:~\char34}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\>[17]{}\mathrel{=}\bot {}\<[E]%
\\
\>[B]{}\Varid{outNEList}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseNEList}\;\Varid{f}\;\Varid{g}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
...
\>[16]{}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloNEList}\;\Varid{h}\;\Varid{g}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Gene do anamorfismo:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 list2LTree}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
